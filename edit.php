...
<head>
    ...
    <title>Edit Data Siswa - Modern Form</title>
    ...
    <style>
        ...
        :root {
            ...
            --gradient-edit: linear-gradient(135deg, #F2994A 0%, #F2C94C 100%);
        }
        ...
        * {
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 30px 50px rgba(242, 153, 74, 0.5);
            animation: none;
        }
        ...
        .info-card i {
            font-size: 24px;
            color: var(--tertiary);
            animation: infoIcon 2s infinite;
        }
...
<body>
    ...
    <div class="container">
        ...
        <!-- Info Card untuk menampilkan ID yang diedit -->
        <div class="info-card">
            <i class="fas fa-info-circle"></i>
            <div class="info-text">
                Sedang mengedit data dengan ID: <strong>#<?= htmlspecialchars($data['id']) ?></strong>
            </div>
        </div>

        <!-- Form Card -->
        <div class="form-card">
            <form action="proses_edit.php" method="POST" id="editForm">
                ...
                <div class="form-group" id="alamatGroup">
                    ...
                    <textarea name="alamat" 
                              ...
                              required
                              data-tooltip="Edit alamat siswa"
                              id="alamatInput"><?= htmlspecialchars($data['alamat']) ?></textarea>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('input, textarea, button, a').forEach(element => {
            element.addEventListener('mouseenter', () => {
                ...
                cursor.style.background = 'rgba(242, 201, 76, 0.1)';
            });
        ...
        setTimeout(() => {
            ...
            alamatInput.dispatchEvent(event);
        }, 100);
        ...
        // Konfirmasi sebelum meninggalkan halaman jika form sudah diubah
        ...
        inputs.forEach(input => {
            input.addEventListener('input', function() {
                const currentNama = document.getElementById('namaInput').value;
                const currentKelas = document.getElementById('kelasInput').value;
                const currentAlamat = document.getElementById('alamatInput').value;
                
                if (currentNama !== originalData.nama || 
                    currentKelas !== originalData.kelas || 
                    currentAlamat !== originalData.alamat) {
                    formChanged = true;
                } else {
                    formChanged = false;
                }
        ...
        // Tambahan animasi untuk info card
    ...
    <style>
        ...
        /* Efek untuk input yang valid (menampilkan data existing sebagai valid) */
        .form-group input:valid,
        .form-group textarea:valid {
